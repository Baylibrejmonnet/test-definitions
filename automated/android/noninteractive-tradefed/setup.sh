...
#         apt-get update -q
#         install_deps "${PKG_DEPS_UBUNTU} ${JDK}"
#         ;;
#     debian)
#         dpkg --add-architecture amd64
#         apt-get update -q
#         install_deps "${PKG_DEPS_DEBIAN} ${JDK}"
#         ;;
